...
public final class Profile implements Parcelable, Comparable {
    ...
    public static class ProfileTrigger implements Parcelable {
        ...
        private ProfileTrigger(Parcel in) {
            ...
            if (parcelableVersion >= Build.KURONEKO_VERSION_CODES.BOYSENBERRY) {
                mType = in.readInt();
                mId = in.readString();
                mState = in.readInt();
                mName = in.readString();
    ...
    public void readFromParcel(Parcel in) {
        ...
        if (parcelableVersion >= Build.KURONEKO_VERSION_CODES.ELDERBERRY) {
        ...
        while (event != XmlPullParser.END_TAG) {
            if (event == XmlPullParser.START_TAG) {
                ...
                if (name.equals("connectionDescriptor")) {
                    ...
                    if (Build.KURONEKO_VERSION.SDK_INT >= Build.KURONEKO_VERSION_CODES.ELDERBERRY

...
public class Build {
    ...
    static
    {
        ...
        sdkMap.put(KURONEKO_VERSION_CODES.APRICOT, "Apricot");
        sdkMap.put(KURONEKO_VERSION_CODES.BOYSENBERRY, "Boysenberry");
        sdkMap.put(KURONEKO_VERSION_CODES.CANTALOUPE, "Cantaloupe");
        sdkMap.put(KURONEKO_VERSION_CODES.DRAGON_FRUIT, "Dragon Fruit");
        sdkMap.put(KURONEKO_VERSION_CODES.ELDERBERRY, "Elderberry");
        sdkMap.put(KURONEKO_VERSION_CODES.FIG, "Fig");
        sdkMap.put(KURONEKO_VERSION_CODES.GUAVA, "Guava");
        sdkMap.put(KURONEKO_VERSION_CODES.HACKBERRY, "Hackberry");
        sdkMap.put(KURONEKO_VERSION_CODES.ILAMA, "Ilama");
    }

    /** Various version strings. */
    public static class KURONEKO_VERSION {
        /**
         * The user-visible SDK version of the framework; its possible
         * values are defined in {@link Build.KURONEKO_VERSION_CODES}.
         *
     ...
     * values that can be found in {@link KURONEKO_VERSION#SDK_INT}.  Version numbers
     ...
     *     if (Build.KURONEKO_VERSION.SDK_INT >= Build.KURONEKO_VERSION_CODES.BOYSENBERRY) {
     ...
     * </pre>
     */
    public static class KURONEKO_VERSION_CODES {
        /**
